...
public class Spawner : MonoBehaviour
{
    ...
    float timeSinceLastSpawn = 0.0f; //Tracks the time since between spawing objects

    public float minSpawnTime = 0.5f; //Minimum amount of time between spawning objects
    public float maxSpawnTime = 1.0f; //Maximum amount of time between spawning objects
